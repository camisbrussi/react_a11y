    ...
    <>
      ...
      <header className={styles.header}>
        ...
        <nav className={styles.nav}>
          <a href="https://github.com/camisbrussi" aria-label="Github">
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
      ...
      <main>
        <article className={styles.content}>
          <header>
            ...
            <h2>
              Compreensão de boas práticas sobre acessibilidade é fundamental
              para desenvolvedores inseridos no atual mercado de trabalho
            </h2>
          </header>
        ...
        <nav className={styles.nav} aria-label="rodapé">
          <Dialog.Root>
            <Dialog.Trigger asChild>
              <button aria-controls="modal1">Termos de uso</button>
            </Dialog.Trigger>
            <Dialog.Portal>
